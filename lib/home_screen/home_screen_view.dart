...
import 'package:my_shop/cart_screen/cart_screen.dart';
import 'package:my_shop/categories_and_featured_screen/categories_and_featured_screen.dart';
import 'package:my_shop/home_screen/drawer.dart';
import 'package:my_shop/home_screen/home_screen_controller.dart';
import 'package:my_shop/home_screen/model_class/categories_model.dart';
import 'package:my_shop/items_screen/items_screen.dart';
        ...
        child: GetBuilder<HomeScreenController>(
          builder: (value) {
            if (!value.isLoading) {
              return Scaffold(
                appBar: AppBar(
                  title: const Text("Shop From Home"),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        categoriesTitle(size, "Most Popular", () {
                          Get.to(() => CategoriesAndFeaturedScreen(
